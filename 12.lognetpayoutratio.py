# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 14:13:30 2019
...
payout_ratio = payout_ratio[payout_ratio.index>=start]

var_no = '12'
payout_ratio.columns = [var_no+'_'+i for i in payout_ratio.columns] 
payout_ratio_log = np.log(payout_ratio+1)



payout_ratio_log.to_excel('C:/Users/sb0538/Desktop/15022020/excels/12_netpayoutratiolog.xlsx') 
